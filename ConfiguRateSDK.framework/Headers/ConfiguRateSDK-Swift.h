...
SWIFT_MODULE_NAMESPACE_PUSH("ConfiguRateSDK")
@class NSCoder;
@class UIViewController;

/// This class to initialize & handle button ConfiguRate
SWIFT_CLASS("_TtC14ConfiguRateSDK17ConfiguRateButton")
@interface ConfiguRateButton : UIButton
...
/// \param target pass a view controller that you want to show up there
///
/// \param virtualId pass your virtual device id
///
- (nonnull instancetype)initWithTarget:(UIViewController * _Nonnull)target virtualId:(NSString * _Nonnull)virtualId udid:(NSString * _Nonnull)udid OBJC_DESIGNATED_INITIALIZER;
...
///
/// \endcode
SWIFT_CLASS("_TtC14ConfiguRateSDK13OnAckCallback")
...
SWIFT_CLASS("_TtC14ConfiguRateSDK7SSLCert")
...
SWIFT_CLASS("_TtC14ConfiguRateSDK16SocketAckEmitter")
...
SWIFT_CLASS("_TtC14ConfiguRateSDK14SocketAnyEvent")
...
///
/// \endcode
SWIFT_CLASS("_TtC14ConfiguRateSDK19SocketClientManager")
...
SWIFT_CLASS("_TtC14ConfiguRateSDK12SocketEngine")
...
@interface SocketEngine (SWIFT_EXTENSION(ConfiguRateSDK))
...
SWIFT_PROTOCOL("_TtP14ConfiguRateSDK18SocketEngineClient_")
@protocol SocketEngineClient
...
SWIFT_PROTOCOL("_TtP14ConfiguRateSDK16SocketEngineSpec_")
...
SWIFT_CLASS("_TtC14ConfiguRateSDK14SocketIOClient")
...
SWIFT_CLASS("_TtC14ConfiguRateSDK9WebSocket")
